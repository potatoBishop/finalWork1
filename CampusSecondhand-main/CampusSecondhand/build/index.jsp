...
<%--	<style>--%>
<%--		body {--%>
<%--			background-image: url(/build/static/image/058.png);--%>
					...
					<div class="col-md-12">
						<div class="list-group">
							<span class="list-group-item list-group-item-info">分类</span> <a
								...
								class="badge"></span>二手书籍</a> <a href="index.jsp?ceta=5"
				...
				<div class="list-group">
					<%
						...
						case 0:
							...
							break;
						case 1:
							out.println("<span class=\"list-group-item list-group-item-info\">分类-二手书籍</span>");
