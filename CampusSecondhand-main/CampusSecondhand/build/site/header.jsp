...
<div class="container">
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="<%=basePath %>index.jsp?ceta=0" style="font-size: 24px;   ">
			<img src="<%=basePath %>static/image/favicon.ico" alt="QDU二手交易平台" style="width:10%; display: inline-block;">
			<div style="display: inline-block;">校内二手物品交易平台</div>
		</a>
	</div>
